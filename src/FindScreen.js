...
// 5x
import { createMaterialTopTabNavigator } from '@react-navigation/material-top-tabs';//界面导航
    ...
    render() {
        return (
            ...
            <SafeAreaView style={{ flex: 1 }}>
                ...
                {/* 5x */}
                <Tab.Navigator>
                    <Tab.Screen name="萨摩" component={HomeScreen} />
                    <Tab.Screen name="哈士奇" component={SettingsScreen} />
                    <Tab.Screen name="拉布拉多" component={ProfileScreen} />
                    <Tab.Screen name="阿拉斯加" component={FeedScreen} />
                    <Tab.Screen name="柴犬" component={FeedScreen2} />
                </Tab.Navigator>
            </SafeAreaView>
        );
    }
